...
const socket = io(process.env.REACT_APP_BACKEND_URL || "https://your-deployed-backend.com", {
...
const App = () => {
  ...
  useEffect(() => {
    ...
    return () => events.forEach(({ event, handler }) => socket.off(event, handler));
  }, []);
  ...
  return (
    <div className="editor-container">
      <div className="sidebar">
        ...
        <button className="leave-button" onClick={() => setJoined(false)}>Leave Room</button>
      </div>
